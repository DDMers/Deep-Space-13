...
/datum/controller/subsystem/shuttle/proc/requestEvac(mob/user, call_reason)
	...
	deadchat_broadcast("<span_class='deadsay'><span_class='name'>[user.real_name]</span> has called the shuttle at <span_class='name'>[A.name]</span>.</span>", user)
	if(call_reason)
...
/datum/controller/subsystem/shuttle/proc/cancelEvac(mob/user)
	if(canRecall())
		...
		deadchat_broadcast("<span_class='deadsay'><span_class='name'>[user.real_name]</span> has recalled the shuttle from <span_class='name'>[get_area_name(user, TRUE)]</span>.</span>", user)
		return 1
