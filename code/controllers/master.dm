...
/datum/controller/master/Recover()
	...
	if(istype(BadBoy))
		...
		if(msg)
			to_chat(GLOB.admins, "<span_class='boldannounce'>[msg]</span>")
			log_world(msg)
	...
	if (istype(Master.subsystems))
		...
		to_chat(world, "<span_class='boldannounce'>The Master Controller is having some issues, we will need to re-initialize EVERYTHING</span>")
		Initialize(20, TRUE)
...
/datum/controller/master/Initialize(delay, init_sss, tgs_prime)
	...
	to_chat(world, "<span_class='boldannounce'>Initializing subsystems...</span>")
