...
/datum/weather
	...
	var/telegraph_message = "<span_class='warning'>The wind begins to pick up.</span>" //The message displayed in chat to foreshadow the weather's beginning
	...
	var/weather_message = "<span_class='userdanger'>The wind begins to blow ferociously!</span>" //Displayed in chat once the weather begins in earnest
	...
	var/end_message = "<span_class='danger'>The wind relents its assault.</span>" //Displayed once the weather is over
