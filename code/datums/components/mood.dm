...
/datum/component/mood/proc/print_mood(mob/user)
	...
	msg += "<span_class='notice'>My mental status: </span>" //Long term
	switch(sanity)
		if(SANITY_GREAT to INFINITY)
			msg += "<span_class='nicegreen'>My mind feels like a temple!<span>\n"
		if(SANITY_NEUTRAL to SANITY_GREAT)
			msg += "<span_class='nicegreen'>I have been feeling great lately!<span>\n"
		if(SANITY_DISTURBED to SANITY_NEUTRAL)
			msg += "<span_class='nicegreen'>I have felt quite decent lately.<span>\n"
		if(SANITY_UNSTABLE to SANITY_DISTURBED)
			msg += "<span_class='warning'>I'm feeling a little bit unhinged...</span>\n"
		if(SANITY_CRAZY to SANITY_UNSTABLE)
			msg += "<span_class='boldwarning'>I'm freaking out!!</span>\n"
		if(SANITY_INSANE to SANITY_CRAZY)
			msg += "<span_class='boldwarning'>AHAHAHAHAHAHAHAHAHAH!!</span>\n"

	msg += "<span_class='notice'>My current mood: </span>" //Short term
	switch(mood_level)
		if(1)
			msg += "<span_class='boldwarning'>I wish I was dead!<span>\n"
		if(2)
			msg += "<span_class='boldwarning'>I feel terrible...<span>\n"
		if(3)
			msg += "<span_class='boldwarning'>I feel very upset.<span>\n"
		if(4)
			msg += "<span_class='boldwarning'>I'm a bit sad.<span>\n"
		if(5)
			msg += "<span_class='nicegreen'>I'm alright.<span>\n"
		if(6)
			msg += "<span_class='nicegreen'>I feel pretty okay.<span>\n"
		if(7)
			msg += "<span_class='nicegreen'>I feel pretty good.<span>\n"
		if(8)
			msg += "<span_class='nicegreen'>I feel amazing!<span>\n"
		if(9)
			msg += "<span_class='nicegreen'>I love life!<span>\n"

	msg += "<span_class='notice'>Moodlets:\n</span>"//All moodlets
	if(mood_events.len)
		for(var/i in mood_events)
			var/datum/mood_event/event = mood_events[i]
			msg += event.description
	else
		msg += "<span_class='nicegreen'>I don't have much of a reaction to anything right now.<span>\n"
