...
/datum/symptom/fever/Activate(datum/disease/advance/A)
	...
	if(!unsafe || A.stage < 4)
		to_chat(M, "<span_class='warning'>[pick("You feel hot.", "You feel like you're burning.")]</span>")
	else
		to_chat(M, "<span_class='userdanger'>[pick("You feel too hot.", "You feel like your blood is boiling.")]</span>")
