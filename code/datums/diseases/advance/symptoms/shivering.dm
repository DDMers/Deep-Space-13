...
/datum/symptom/shivering/Activate(datum/disease/advance/A)
	...
	if(!unsafe || A.stage < 4)
		to_chat(M, "<span_class='warning'>[pick("You feel cold.", "You shiver.")]</span>")
	else
		to_chat(M, "<span_class='userdanger'>[pick("You feel your blood run cold.", "You feel ice in your veins.", "You feel like you can't heat up.", "You shiver violently." )]</span>")
