...
/datum/disease/cold/stage_act()
	...
	switch(stage)
		if(2)
			...
			if(prob(1))
				to_chat(affected_mob, "<span_class='danger'>Your throat feels sore.</span>")
			if(prob(1))
				to_chat(affected_mob, "<span_class='danger'>Mucous runs down the back of your throat.</span>")
		if(3)
