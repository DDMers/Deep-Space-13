...
/datum/disease/transformation/jungle_fever
	...
	stage2	= list()
	stage3	= list()
	stage4	= list("<span_class='warning'>Your back hurts.</span>", "<span_class='warning'>You breathe through your mouth.</span>",
					"<span_class='warning'>You have a craving for bananas.</span>", "<span_class='warning'>Your mind feels clouded.</span>")
	stage5	= list("<span_class='warning'>You feel like monkeying around.</span>")
...
/datum/disease/transformation/jungle_fever/stage_act()
	...
	switch(stage)
		if(2)
			if(prob(2))
				to_chat(affected_mob, "<span_class='notice'>Your [pick("back", "arm", "leg", "elbow", "head")] itches.</span>")
		if(3)
			if(prob(4))
				to_chat(affected_mob, "<span_class='danger'>You feel a stabbing pain in your head.</span>")
...
/datum/disease/transformation/robot
	...
	visibility_flags = 0
	stage1	= list()
	stage2	= list("Your joints feel stiff.", "<span_class='danger'>Beep...boop..</span>")
	stage3	= list("<span_class='danger'>Your joints feel very stiff.</span>", "Your skin feels loose.", "<span_class='danger'>You can feel something move...inside.</span>")
	stage4	= list("<span_class='danger'>Your skin feels very loose.</span>", "<span_class='danger'>You can feel... something...inside you.</span>")
	stage5	= list("<span_class='danger'>Your skin feels as if it's about to burst off!</span>")
...
/datum/disease/transformation/xeno
	...
	visibility_flags = 0
	stage1	= list()
	stage2	= list("Your throat feels scratchy.", "<span_class='danger'>Kill...</span>")
	stage3	= list("<span_class='danger'>Your throat feels very scratchy.</span>", "Your skin feels tight.", "<span_class='danger'>You can feel something move...inside.</span>")
	stage4	= list("<span_class='danger'>Your skin feels very tight.</span>", "<span_class='danger'>Your blood boils!</span>", "<span_class='danger'>You can feel... something...inside you.</span>")
	stage5	= list("<span_class='danger'>Your skin feels as if it's about to burst off!</span>")
...
/datum/disease/transformation/slime
	...
	stage3	= list("<span_class='danger'>Your appendages are melting away.</span>", "<span_class='danger'>Your limbs begin to lose their shape.</span>")
	stage4	= list("<span_class='danger'>You are turning into a slime.</span>")
	stage5	= list("<span_class='danger'>You have become a slime.</span>")
...
/datum/disease/transformation/corgi
	...
	stage3	= list("<span_class='danger'>Must... eat... chocolate....</span>", "<span_class='danger'>YAP</span>")
	stage4	= list("<span_class='danger'>Visions of washing machines assail your mind!</span>")
	stage5	= list("<span_class='danger'>AUUUUUU!!!</span>")
...
/datum/disease/transformation/morph
	...
	stage3	= list("<span_class='danger'>Your appendages are melting away.</span>", "<span_class='danger'>Your limbs begin to lose their shape.</span>")
	stage4	= list("<span_class='danger'>You're ravenous.</span>")
	stage5	= list("<span_class='danger'>You have become a morph.</span>")
...
/datum/disease/transformation/gondola
	...
	stage3	= list("<span_class='danger'>A cruel sense of calm overcomes you.</span>", "<span_class='danger'>You can't feel your arms!</span>", "<span_class='danger'>You let go of the urge to hurt clowns.</span>")
	stage4	= list("<span_class='danger'>You can't feel your arms. It does not bother you anymore.</span>", "<span_class='danger'>You forgive the clown for hurting you.</span>")
	stage5	= list("<span_class='danger'>You have become a Gondola.</span>")
	...
	switch(stage)
		...
		if(4)
			...
			if (prob(20))
				affected_mob.reagents.add_reagent_list(list("pax" = 5))
			if (prob(2))
				to_chat(affected_mob, "<span_class='danger'>You let go of what you were holding.</span>")
