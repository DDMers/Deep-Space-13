...
/datum/brain_trauma/hypnosis/on_gain()
	...
	to_chat(owner, "<span_class='reallybig hypnophrase'>[hypnotic_phrase]</span>")
	to_chat(owner, "<span_class='notice'>[pick("You feel your thoughts focusing on this phrase... you can't seem to get it out of your head.",\
	...
	to_chat(owner, "<span_class='boldwarning'>You've been hypnotized by this sentence. You must follow these words. If it isn't a clear order, you can freely interpret how to do so,\
...
/datum/brain_trauma/hypnosis/on_lose()
	...
	to_chat(owner, "<span_class='userdanger'>You suddenly snap out of your hypnosis. The phrase '[hypnotic_phrase]' no longer feels important to you.</span>")
	..()
...
/datum/brain_trauma/hypnosis/on_life()
	...
	if(prob(2))
		switch(rand(1,2))
			...
			if(2)
				new /datum/hallucination/chat(owner, TRUE, FALSE, "<span_class='hypnophrase'>[hypnotic_phrase]</span>")
...
/datum/brain_trauma/hypnosis/on_hear(message, speaker, message_language, raw_message, radio_freq)
	...
	message = target_phrase.Replace(message, "<span_class='hypnophrase'>$1</span>")
	return message