...
/datum/brain_trauma/severe/mute
	...
	gain_text = "<span_class='warning'>You forget how to speak!</span>"
	lose_text = "<span_class='notice'>You suddenly remember how to speak.</span>"
...
/datum/brain_trauma/severe/aphasia
	...
	gain_text = "<span_class='warning'>You have trouble forming words in your head...</span>"
	lose_text = "<span_class='notice'>You suddenly remember how languages work.</span>"
...
/datum/brain_trauma/severe/blindness
	...
	gain_text = "<span_class='warning'>You can't see!</span>"
	lose_text = "<span_class='notice'>Your vision returns.</span>"
...
/datum/brain_trauma/severe/paralysis/New(specific_type)
	...
	gain_text = "<span_class='warning'>You can't feel [subject] anymore!</span>"
	lose_text = "<span_class='notice'>You can feel [subject] again!</span>"
...
/datum/brain_trauma/severe/narcolepsy
	...
	gain_text = "<span_class='warning'>You have a constant feeling of drowsiness...</span>"
	lose_text = "<span_class='notice'>You feel awake and aware again.</span>"
...
/datum/brain_trauma/severe/narcolepsy/on_life()
	...
	if(prob(sleep_chance))
		to_chat(owner, "<span_class='warning'>You fall asleep.</span>")
		owner.Sleeping(60)
	else if(!owner.drowsyness && prob(sleep_chance * 2))
		to_chat(owner, "<span_class='warning'>You feel tired...</span>")
		owner.drowsyness += 10
...
/datum/brain_trauma/severe/monophobia
	...
	gain_text = ""
	lose_text = "<span_class='notice'>You feel like you could be safe on your own.</span>"
	var/stress = 0

/datum/brain_trauma/severe/monophobia/on_gain()
	..()
	if(check_alone())
		to_chat(owner, "<span_class='warning'>You feel really lonely...</span>")
	else
		to_chat(owner, "<span_class='notice'>You feel safe, as long as you have people around you.</span>")
...
/datum/brain_trauma/severe/monophobia/proc/stress_reaction()
	...
	switch(rand(1,6))
		if(1)
			if(!high_stress)
				to_chat(owner, "<span_class='warning'>You feel sick...</span>")
			else
				to_chat(owner, "<span_class='warning'>You feel really sick at the thought of being alone!</span>")
			addtimer(CALLBACK(owner, /mob/living/carbon.proc/vomit, high_stress), 50) //blood vomit if high stress
		if(2)
			if(!high_stress)
				to_chat(owner, "<span_class='warning'>You can't stop shaking...</span>")
				owner.dizziness += 20
				owner.confused += 20
				owner.Jitter(20)
			else
				to_chat(owner, "<span_class='warning'>You feel weak and scared! If only you weren't alone...</span>")
				owner.dizziness += 20
				owner.confused += 20
				owner.Jitter(20)
		...
		if(3, 4)
			if(!high_stress)
				...
				to_chat(owner, "<span_class='warning'>You're going mad with loneliness!</span>")
				owner.hallucination += 30

		if(5)
			if(!high_stress)
				to_chat(owner, "<span_class='warning'>Your heart skips a beat.</span>")
				owner.adjustOxyLoss(8)
			else
				if(prob(15) && ishuman(owner))
					var/mob/living/carbon/human/H = owner
					H.set_heartattack(TRUE)
					to_chat(H, "<span_class='userdanger'>You feel a stabbing pain in your heart!</span>")
				else
...
/datum/brain_trauma/severe/discoordination
	...
	gain_text = "<span_class='warning'>You can barely control your hands!</span>"
	lose_text = "<span_class='notice'>You feel in control of your hands again.</span>"
...
/datum/brain_trauma/severe/pacifism
	...
	gain_text = "<span_class='notice'>You feel oddly peaceful.</span>"
	lose_text = "<span_class='notice'>You no longer feel compelled to not harm.</span>"
...
/datum/brain_trauma/severe/hypnotic_stupor
	...
	gain_text = "<span_class='warning'>You feel somewhat dazed.</span>"
	lose_text = "<span_class='notice'>You feel like a fog was lifted from your mind.</span>"
