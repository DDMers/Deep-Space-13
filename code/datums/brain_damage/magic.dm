...
/datum/brain_trauma/magic/lumiphobia
	...
	gain_text = "<span_class='warning'>You feel a craving for darkness.</span>"
	lose_text = "<span_class='notice'>Light no longer bothers you.</span>"
	...
	if(istype(T))
		...
		if(light_amount > SHADOW_SPECIES_LIGHT_THRESHOLD) //if there's enough light, start dying
			if(world.time > next_damage_warning)
				to_chat(owner, "<span_class='warning'><b>The light burns you!</b></span>")
...
/datum/brain_trauma/magic/poltergeist
	...
	gain_text = "<span_class='warning'>You feel a hateful presence close to you.</span>"
	lose_text = "<span_class='notice'>You feel the hateful presence fade away.</span>"
...
/datum/brain_trauma/magic/antimagic
	...
	gain_text = "<span_class='notice'>You realize that magic cannot be real.</span>"
	lose_text = "<span_class='notice'>You realize that magic might be real.</span>"
...
/datum/brain_trauma/magic/stalker
	...
	gain_text = "<span_class='warning'>You feel like something wants to kill you...</span>"
	lose_text = "<span_class='notice'>You no longer feel eyes on your back.</span>"
...
/datum/brain_trauma/magic/stalker/on_life()
	...
	if(get_dist(owner, stalker) <= 1)
		...
		owner.visible_message("<span_class='warning'>[owner] is torn apart by invisible claws!</span>", "<span_class='userdanger'>Ghostly claws tear your body apart!</span>")
