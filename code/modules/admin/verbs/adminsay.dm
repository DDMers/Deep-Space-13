/client/proc/cmd_admin_say(msg as text)
	...
	msg = "<span_class='adminsay'><span_class='prefix'>ADMIN:</span> <EM>[key_name(usr, 1)]</EM> [ADMIN_FLW(mob)]: [custom_asay_color]<span_class='message linkify'>[msg]</span></span>[custom_asay_color ? "</font>":null]"
