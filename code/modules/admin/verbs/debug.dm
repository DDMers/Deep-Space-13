...
/proc/WrapAdminProcCall(datum/target, procname, list/arguments)
	...
	if(current_caller && current_caller != ckey)
		if(!GLOB.AdminProcCallSpamPrevention[ckey])
			to_chat(usr, "<span_class='adminnotice'>Another set of admin called procs are still running, your proc will be run after theirs finish.</span>")
			GLOB.AdminProcCallSpamPrevention[ckey] = TRUE
			UNTIL(!GLOB.AdminProcCaller)
			to_chat(usr, "<span_class='adminnotice'>Running your proc</span>")
...
/client/proc/callproc_datum(datum/A as null|area|mob|obj|turf)
	...
	if(!A || !IsValidSrc(A))
		to_chat(usr, "<span_class='warning'>Error: callproc_datum(): owner of proc no longer exists.</span>")
		return
...
/client/proc/get_callproc_returnval(returnval,procname)
	...
	if(islist(returnval))
		...
		. = "<span_class='notice'>[procname] returned: [!isnull(returnval) ? returnval : "null"]</span>"
...
/client/proc/cmd_admin_alienize(mob/M in GLOB.mob_list)
	...
	if(ishuman(M))
		...
		message_admins("<span_class='adminnotice'>[key_name_admin(usr)] made [ADMIN_LOOKUPFLW(M)] into an alien.</span>")
	else
		alert("Invalid mob")
...
/client/proc/cmd_admin_slimeize(mob/M in GLOB.mob_list)
	...
	if(ishuman(M))
		...
		message_admins("<span_class='adminnotice'>[key_name_admin(usr)] made [ADMIN_LOOKUPFLW(M)] into a slime.</span>")
	else
		alert("Invalid mob")
...
/client/proc/cmd_admin_grantfullaccess(mob/M in GLOB.mob_list)
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] has granted [M.key] full access.</span>")
...
/client/proc/cmd_assume_direct_control(mob/M in GLOB.mob_list)
	...
	if(M.ckey)
		if(alert("This mob is being controlled by [M.key]. Are you sure you wish to assume control of it? [M.key] will be made a ghost.",,"Yes","No") != "Yes")
			...
			ghost.ckey = M.ckey
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] assumed direct control of [M].</span>")
...
/client/proc/cmd_admin_test_atmos_controllers()
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] used the Test Atmos Monitor debug command.</span>")
...
/client/proc/cmd_admin_areatest(on_station)
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] used the Test Areas debug command checking [log_message].</span>")
...
/client/proc/cmd_admin_dress(mob/M in GLOB.mob_list)
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] changed the equipment of [ADMIN_LOOKUPFLW(H)] to [dresscode].</span>")
...
/client/proc/jump_to_ruin()
	...
	if(istype(landmark))
		...
		to_chat(usr, "<span_class='name'>[template.name]</span>")
		to_chat(usr, "<span_class='italics'>[template.description]</span>")
...
/client/proc/place_ruin()
	...
	if (GLOB.ruin_landmarks.len > len)
		...
		usr.forceMove(get_turf(landmark))
		to_chat(src, "<span_class='name'>[template.name]</span>")
		to_chat(src, "<span_class='italics'>[template.description]</span>")
	else
		to_chat(src, "<span_class='warning'>Failed to place [template.name].</span>")
...
/client/proc/clear_dynamic_transit()
	...
	if(answer != "YES")
		return
	message_admins("<span_class='adminnotice'>[key_name_admin(src)] cleared dynamic transit space.</span>")
...
/client/proc/toggle_medal_disable()
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(src)] [SSmedals.hub_enabled ? "disabled" : "enabled"] the medal hub lockout.</span>")
...
/client/proc/pump_random_event()
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(src)] pumped a random event.</span>")
...
/client/proc/start_line_profiling()
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(src)] started line by line profiling.</span>")
...
/client/proc/stop_line_profiling()
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(src)] stopped line by line profiling.</span>")
