...
/client/proc/only_one() //Gives everyone kilts, berets, claymores, and pinpointers, with the objective to hijack the emergency shuttle.
	...
	send_to_playing_players("<span_class='boldannounce'><font size=6>THERE CAN BE ONLY ONE</font></span>")
	...
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] used THERE CAN BE ONLY ONE!</span>")
...
/client/proc/only_one_delayed()
	send_to_playing_players("<span_class='userdanger'>Bagpipes begin to blare. You feel Scottish pride coming over you.</span>")
	message_admins("<span_class='adminnotice'>[key_name_admin(usr)] used (delayed) THERE CAN BE ONLY ONE!</span>")
