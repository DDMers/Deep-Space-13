...
/client/verb/toggle_inquisition() // warning: unexpected inquisition
	...
	if(prefs.inquisitive_ghost)
		to_chat(src, "<span_class='notice'>You will now examine everything you click on.</span>")
	else
		to_chat(src, "<span_class='notice'>You will no longer examine things you click on.</span>")
