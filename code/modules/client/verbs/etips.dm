/client/verb/toggle_tips()
	...
	to_chat(usr, "<span_class='danger'>Examine tooltips [prefs.enable_tips ? "en" : "dis"]abled.</span>")
...
/client/verb/change_tip_delay()
	...
	if(usr)//is this what you mean?
		...
		prefs.save_preferences()
		to_chat(usr, "<span_class='danger'>Tooltip delay set to [indelay] milliseconds.</span>")
