...
/obj/item/bodypart/proc/dismember(dam_type = BRUTE)
	...
	C.visible_message("<span_class='danger'><B>[C]'s [src.name] has been violently dismembered!</B></span>")
	C.emote("scream")
...
/obj/item/bodypart/chest/dismember()
	...
	if(organ_spilled)
		C.visible_message("<span_class='danger'><B>[C]'s internal organs spill out onto the floor!</B></span>")
