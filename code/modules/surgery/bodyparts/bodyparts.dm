...
/obj/item/bodypart/proc/is_disabled()
	...
	if(can_dismember() && !owner.has_trait(TRAIT_NOLIMBDISABLE))
		...
		if((get_damage(TRUE) >= max_damage) || (owner.has_trait(TRAIT_EASYLIMBDISABLE) && (get_damage(TRUE) >= (max_damage * 0.45)))) //Easy limb disable disables the limb at 40% health instead of 0%
