...
/datum/surgery_step/lobotomize/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	user.visible_message("[user] begins to cut a piece of [target]'s brain.", "<span_class='notice'>You begin to cut a piece of [target]'s brain...</span>")

/datum/surgery_step/lobotomize/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	user.visible_message("[user] successfully lobotomizes [target]!", "<span_class='notice'>You succeed in lobotomizing [target].</span>")
...
/datum/surgery_step/lobotomize/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	if(target.getorganslot(ORGAN_SLOT_BRAIN))
		user.visible_message("<span_class='warning'>[user] removes the wrong part, causing more damage!</span>", "<span_class='warning'>You remove the wrong part, causing more damage!</span>")
