...
/obj/item/organ/cyberimp/brain/emp_act(severity)
	...
	to_chat(owner, "<span_class='warning'>Your body seizes up!</span>")
...
/obj/item/organ/cyberimp/brain/anti_drop/ui_action_click()
	...
	if(active)
		...
		if(LAZYLEN(L) == owner.held_items.len)
			to_chat(owner, "<span_class='notice'>You are not holding any items, your hands relax...</span>")
			active = 0
			stored_items = list()
		else
			for(var/obj/item/I in stored_items)
				to_chat(owner, "<span_class='notice'>Your [owner.get_held_index_name(owner.get_held_index_of_item(I))]'s grip tightens.</span>")
				I.item_flags |= NODROP

	else
		release_items()
		to_chat(owner, "<span_class='notice'>Your hands relax...</span>")
...
/obj/item/organ/cyberimp/brain/anti_drop/emp_act(severity)
	...
	for(var/obj/item/I in stored_items)
		...
		to_chat(owner, "<span_class='warning'>Your [owner.get_held_index_name(owner.get_held_index_of_item(I))] spasms and throws the [I.name]!</span>")
	stored_items = list()
...
/obj/item/organ/cyberimp/mouth/breathing_tube/emp_act(severity)
	...
	if(!owner || . & EMP_PROTECT_SELF)
		return
	if(prob(60/severity))
		to_chat(owner, "<span_class='warning'>Your breathing tube suddenly closes!</span>")
		owner.losebreath += 2
