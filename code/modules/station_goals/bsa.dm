...
/obj/machinery/bsa/back/multitool_act(mob/living/user, obj/item/I)
	...
	M.buffer = src
	to_chat(user, "<span_class='notice'>You store linkage information in [I]'s buffer.</span>")
	return TRUE
...
/obj/machinery/bsa/middle/multitool_act(mob/living/user, obj/item/I)
	...
	if(M.buffer)
		if(istype(M.buffer, /obj/machinery/bsa/back))
			back = M.buffer
			M.buffer = null
			to_chat(user, "<span_class='notice'>You link [src] with [back].</span>")
		else if(istype(M.buffer, /obj/machinery/bsa/front))
			front = M.buffer
			M.buffer = null
			to_chat(user, "<span_class='notice'>You link [src] with [front].</span>")
	else
		to_chat(user, "<span_class='warning'>[I]'s data buffer is empty!</span>")
	return TRUE
