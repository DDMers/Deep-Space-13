...
/obj/item/slimecross/regenerative/afterattack(atom/target,mob/user,prox)
	...
	if(H.stat == DEAD)
		to_chat(user, "<span_class='warning'>[src] will not work on the dead!</span>")
		return
	if(H != user)
		user.visible_message("<span_class='notice'>[user] crushes the [src] over [H], the milky goo quickly regenerating all of [H.p_their()] injuries!</span>",
			"<span_class='notice'>You squeeze the [src], and it bursts over [H], the milky goo regenerating [H.p_their()] injuries.</span>")
	else
		user.visible_message("<span_class='notice'>[user] crushes the [src] over [user.p_them()]self, the milky goo quickly regenerating all of [user.p_their()] injuries!</span>",
			"<span_class='notice'>You squeeze the [src], and it bursts in your hand, splashing you with milky goo which quickly regenerates your injuries!</span>")
...
/obj/item/slimecross/regenerative/orange/core_effect_before(mob/living/target, mob/user)
	target.visible_message("<span_class='warning'>The [src] boils over!</span>")
...
/obj/item/slimecross/regenerative/blue/core_effect(mob/living/target, mob/user)
	if(isturf(target.loc))
		...
		target.visible_message("<span_class='warning'>The milky goo in the extract gets all over the floor!</span>")

/obj/item/slimecross/regenerative/metal
	colour = "metal"

/obj/item/slimecross/regenerative/metal/core_effect(mob/living/target, mob/user)
	target.visible_message("<span_class='warning'>The milky goo hardens and reshapes itself, encasing [target]!</span>")
...
/obj/item/slimecross/regenerative/yellow/core_effect(mob/living/target, mob/user)
	...
	if(batteries.len)
		...
		to_chat(target, "<span_class='notice'>You feel a strange electrical pulse, and one of your electrical items was recharged.</span>")
...
/obj/item/slimecross/regenerative/darkpurple/core_effect(mob/living/target, mob/user)
	...
	if(equipped > 0)
		target.visible_message("<span_class='notice'>The milky goo congeals into clothing!</span>")
...
/obj/item/slimecross/regenerative/darkblue/core_effect(mob/living/target, mob/user)
	...
	if(H.get_item_by_slot(SLOT_HEAD))
		...
		fireproof(C)
	if(fireproofed)
		target.visible_message("<span_class='notice'>Some of [target]'s clothing gets coated in the goo, and turns blue!</span>")
...
/obj/item/slimecross/regenerative/silver/core_effect(mob/living/target, mob/user)
	...
	to_chat(target, "<span_class='notice'>You feel satiated.</span>")
...
/obj/item/slimecross/regenerative/bluespace/core_effect(mob/living/target, mob/user)
	target.visible_message("<span_class='warning'>[src] disappears in a shower of sparks!</span>","<span_class='danger'>The milky goo teleports you somewhere it remembers!</span>")
...
/obj/item/slimecross/regenerative/cerulean/core_effect(mob/living/target, mob/user)
	...
	to_chat(user, "<span_class='notice'>Some of the milky goo congeals in your hand!</span>")

/obj/item/slimecross/regenerative/pyrite
	colour = "pyrite"

/obj/item/slimecross/regenerative/pyrite/core_effect(mob/living/target, mob/user)
	target.visible_message("<span_class='warning'>The milky goo coating [target] leaves [target.p_them()] a different color!</span>")
...
/obj/item/slimecross/regenerative/red/core_effect(mob/living/target, mob/user)
	to_chat(target, "<span_class='notice'>You feel... <i>faster.</i></span>")
...
/obj/item/slimecross/regenerative/green/core_effect(mob/living/target, mob/user)
	if(isslime(target))
		target.visible_message("<span_class='warning'>The [target] suddenly changes color!</span>")
...
/obj/item/slimecross/regenerative/pink/core_effect(mob/living/target, mob/user)
	to_chat(target, "<span_class='notice'>You feel more calm.</span>")
...
/obj/item/slimecross/regenerative/black/core_effect_before(mob/living/target, mob/user)
	...
	to_chat(target, "<span_class='notice'>The milky goo flows from your skin, forming an imperfect copy of you.</span>")
	if(iscarbon(target))
...
/obj/item/slimecross/regenerative/lightpink/core_effect(mob/living/target, mob/user)
	...
	to_chat(U, "<span_class='notice'>Some of the milky goo sprays onto you, as well!</span>")
