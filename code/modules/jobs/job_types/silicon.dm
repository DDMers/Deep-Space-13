...
/datum/job/ai
	...
	description = "'Does not compute!' As a ship computer you are responsible for managing the ship's internal systems and keeping a watchful eye out for intruders. As a ship's computer you are capable of autonomy in your decision making but you should always follow your laws."
