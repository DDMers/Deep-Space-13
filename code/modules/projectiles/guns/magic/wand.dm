...
/obj/item/gun/magic/wand/proc/zap_self(mob/living/user)
	user.visible_message("<span_class='danger'>[user] zaps [user.p_them()]self with [src].</span>")
...
/obj/item/gun/magic/wand/death/zap_self(mob/living/user)
	..()
	to_chat(user, "<span_class='warning'>You irradiate yourself with pure energy! \
...
/obj/item/gun/magic/wand/resurrection/zap_self(mob/living/user)
	...
	if(iscarbon(user))
		...
		C.regenerate_limbs()
		C.regenerate_organs()
	to_chat(user, "<span_class='notice'>You feel great!</span>")
	charges--
	..()
...
/obj/item/gun/magic/wand/door/zap_self(mob/living/user)
	to_chat(user, "<span_class='notice'>You feel vaguely more open with your feelings.</span>")
	charges--
	..()
