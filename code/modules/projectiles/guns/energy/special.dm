...
/obj/item/gun/energy/plasmacutter/examine(mob/user)
	..()
	if(cell)
		to_chat(user, "<span_class='notice'>[src] is [round(cell.percent())]% charged.</span>")
...
/obj/item/gun/energy/plasmacutter/attackby(obj/item/I, mob/user)
	...
	if(charge_multiplier)
		if(cell.charge == cell.maxcharge)
			to_chat(user, "<span_class='notice'>You try to insert [I] into [src], but it's fully charged.</span>") //my cell is round and full
			return
		I.use(1)
		cell.give(500*charge_multiplier)
		to_chat(user, "<span_class='notice'>You insert [I] in [src], recharging it.</span>")
	else
		..()
...
/obj/item/gun/energy/plasmacutter/tool_use_check(mob/living/user, amount)
	if(QDELETED(cell))
		to_chat(user, "<span_class='warning'>[src] does not have a cell, and cannot be used!</span>")
		return FALSE
	...
	if(amount ? cell.charge < charge_weld * amount : cell.charge < charge_weld)
		to_chat(user, "<span_class='warning'>You need more charge to complete this task!</span>")
		return FALSE
