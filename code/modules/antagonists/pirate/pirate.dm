...
/datum/antagonist/pirate/greet()
	to_chat(owner, "<span_class='boldannounce'>You are a Space Pirate!</span>")
...
/datum/team/pirate/roundend_report()
	...
	parts += "<span_class='header'>Space Pirates were:</span>"
	...
	if(L.check_completion() && !all_dead)
		parts += "<span_class='greentext big'>The pirate crew was successful!</span>"
	else
		parts += "<span_class='redtext big'>The pirate crew has failed.</span>"
