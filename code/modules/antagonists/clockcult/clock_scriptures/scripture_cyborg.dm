...
/datum/clockwork_scripture/ranged_ability/linked_vanguard
	...
	ranged_message = "<span_class='inathneq_small'><i>You charge the clockwork slab with defensive strength.</i>\n\
...
/datum/clockwork_scripture/ranged_ability/judicial_marker
	...
	ranged_message = "<span_class='neovgre_small'><i>You charge the clockwork slab with judicial force.</i>\n\
