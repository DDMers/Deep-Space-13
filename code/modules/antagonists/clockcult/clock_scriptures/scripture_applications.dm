...
/datum/clockwork_scripture/create_object/sigil_of_transmission
	...
	creator_message = "<span_class='brass'>A sigil silently appears below you. It will automatically power clockwork structures near it and will drain power when activated.</span>"
...
/datum/clockwork_scripture/create_object/mania_motor
	...
	creator_message = "<span_class='brass'>You form a mania motor, which causes minor damage and negative mental effects in non-Servants.</span>"
	observer_message = "<span_class='warning'>A two-pronged machine rises from the ground!</span>"
	invokers_required = 2
...
/datum/clockwork_scripture/create_object/clockwork_obelisk
	...
	creator_message = "<span_class='brass'>You form a clockwork obelisk which can broadcast messages or produce Spatial Gateways.</span>"
	observer_message = "<span_class='warning'>A brass obelisk appears hanging in midair!</span>"
	invokers_required = 2
	multiple_invokers_used = TRUE
...
/datum/clockwork_scripture/create_object/construct/clockwork_marauder
	...
	channel_time = 80
	power_cost = 8000
	creator_message = "<span_class='brass'>Your slab disgorges several chunks of replicant alloy that form into a suit of thrumming armor.</span>"
...
/datum/clockwork_scripture/create_object/construct/clockwork_marauder/update_construct_limit()
	...
	if(recent_marauders)
		to_chat(invoker, "<span_class='warning'>The Hierophant Network is depleted by a summoning in the last [DisplayTimeText(MARAUDER_SCRIPTURE_SCALING_THRESHOLD, TRUE)] - limiting the number of available marauders by [recent_marauders]!</span>")
...
/datum/clockwork_scripture/create_object/construct/clockwork_marauder/pre_recital()
	...
	if(recent_marauders)
		...
		to_chat(invoker, "<span_class='warning'>The Hierophant Network is under strain from repeated summoning, making this scripture [DisplayTimeText(scaled_recital_time)] slower!</span>")
