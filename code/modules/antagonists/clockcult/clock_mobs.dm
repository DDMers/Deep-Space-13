...
/mob/living/simple_animal/hostile/clockwork
	...
	var/playstyle_string = "<span_class='heavy_brass'>You are a bug, yell at whoever spawned you!</span>"
	var/empower_string = "<span_class='heavy_brass'>You have nothing to empower, yell at the coders!</span>" //Shown to the mob when the herald beacon activates
