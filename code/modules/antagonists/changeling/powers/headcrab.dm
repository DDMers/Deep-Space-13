...
/datum/action/changeling/headcrab/sting_action(mob/user)
	...
	for(var/mob/living/carbon/human/H in range(2,user))
		to_chat(H, "<span_class='userdanger'>You are blinded by a shower of blood!</span>")
		H.Stun(20)
		H.blur_eyes(20)
		H.adjust_eye_damage(5)
		H.confused += 3
	for(var/mob/living/silicon/S in range(2,user))
		to_chat(S, "<span_class='userdanger'>Your sensors are disabled by a shower of blood!</span>")
		S.Paralyze(60)
	...
	if(crab.origin)
		...
		to_chat(crab, "<span_class='warning'>You burst out of the remains of your former body in a shower of gore!</span>")
