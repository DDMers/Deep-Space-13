...
/obj/item/organ/heart/gland/examine(mob/user)
	...
	if(user.has_trait(TRAIT_ABDUCTOR_SCIENTIST_TRAINING) || isobserver(user))
		to_chat(user, "<span_class='notice'>It is \a [true_name].</span>")
...
/obj/item/organ/heart/gland/proc/mind_control(command, mob/living/user)
	if(!ownerCheck() || !mind_control_uses || active_mind_control)
		return
	mind_control_uses--
	to_chat(owner, "<span_class='userdanger'>You suddenly feel an irresistible compulsion to follow an order...</span>")
	to_chat(owner, "<span_class='mind_control'>[command]</span>")
...
/obj/item/organ/heart/gland/proc/clear_mind_control()
	if(!ownerCheck() || !active_mind_control)
		return
	to_chat(owner, "<span_class='userdanger'>You feel the compulsion fade, and you completely forget about your previous orders.</span>")
...
/obj/item/organ/heart/gland/heals/activate()
	to_chat(owner, "<span_class='notice'>You feel curiously revitalized.</span>")
...
/obj/item/organ/heart/gland/slime/activate()
	to_chat(owner, "<span_class='warning'>You feel nauseated!</span>")
	owner.vomit(20)
...
/obj/item/organ/heart/gland/mindshock/activate()
	to_chat(owner, "<span_class='notice'>You get a headache.</span>")
	...
	for(var/mob/living/carbon/H in orange(4,T))
		...
		switch(pick(1,3))
			if(1)
				to_chat(H, "<span_class='userdanger'>You hear a loud buzz in your head, silencing your thoughts!</span>")
				H.Stun(50)
			if(2)
				to_chat(H, "<span_class='warning'>You hear an annoying buzz in your head.</span>")
				H.confused += 15
...
/obj/item/organ/heart/gland/pop/activate()
	to_chat(owner, "<span_class='notice'>You feel unlike yourself.</span>")
...
/obj/item/organ/heart/gland/ventcrawling/activate()
	to_chat(owner, "<span_class='notice'>You feel very stretchy.</span>")
...
/obj/item/organ/heart/gland/trauma/activate()
	to_chat(owner, "<span_class='warning'>You feel a spike of pain in your head.</span>")
	if(prob(33))
...
/obj/item/organ/heart/gland/spiderman/activate()
	to_chat(owner, "<span_class='warning'>You feel something crawling in your skin.</span>")
...
/obj/item/organ/heart/gland/egg/activate()
	owner.visible_message("<span_class='alertalien'>[owner] [pick(EGG_LAYING_MESSAGES)]</span>")
...
/obj/item/organ/heart/gland/electric/activate()
	owner.visible_message("<span_class='danger'>[owner]'s skin starts emitting electric arcs!</span>",\
	"<span_class='warning'>You feel electric energy building up inside you!</span>")
...
/obj/item/organ/heart/gland/plasma/activate()
	to_chat(owner, "<span_class='warning'>You feel bloated.</span>")
	addtimer(CALLBACK(GLOBAL_PROC, .proc/to_chat, owner, "<span_class='userdanger'>A massive stomachache overcomes you.</span>"), 150)
	addtimer(CALLBACK(src, .proc/vomit_plasma), 200)

/obj/item/organ/heart/gland/plasma/proc/vomit_plasma()
	if(!owner)
		return
	owner.visible_message("<span_class='danger'>[owner] vomits a cloud of plasma!</span>")
