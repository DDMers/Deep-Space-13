...
/obj/effect/mob_spawn/swarmer/attack_hand(mob/living/user)
	...
	if(.)
		return
	to_chat(user, "<span_class='notice'>Picking up the swarmer may cause it to activate. You should be careful about this.</span>")
...
/obj/effect/mob_spawn/swarmer/attackby(obj/item/W, mob/user, params)
	if(W.tool_behaviour == TOOL_SCREWDRIVER && user.a_intent != INTENT_HARM)
		user.visible_message("<span_class='warning'>[usr.name] deactivates [src].</span>",
			"<span_class='notice'>After some fiddling, you find a way to disable [src]'s power source.</span>",
...
/obj/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	...
	for(var/mob/living/L in contents)
		if(!issilicon(L) && !isbrain(L))
			to_chat(S, "<span_class='warning'>An organism has been detected inside this object. Aborting.</span>")
			return FALSE
	return ..()
...
/obj/machinery/door/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	...
	for(var/turf/T in range(1, src))
		...
		if(isspaceturf(T) || (!isonshuttle && (istype(A, /area/shuttle) || istype(A, /area/space))) || (isonshuttle && !istype(A, /area/shuttle)))
			to_chat(S, "<span_class='warning'>Destroying this object has the potential to cause a hull breach. Aborting.</span>")
			S.target = null
			return FALSE
		else if(istype(A, /area/engine/supermatter))
			to_chat(S, "<span_class='warning'>Disrupting the containment of a supermatter crystal would not be to our benefit. Aborting.</span>")
			S.target = null
			return FALSE
	S.DisIntegrate(src)
	return TRUE
...
/obj/machinery/chem_dispenser/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>The volatile chemicals in this machine would destroy us. Aborting.</span>")
	return FALSE

/obj/machinery/nuclearbomb/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This device's destruction would result in the extermination of everything in the area. Aborting.</span>")
	return FALSE

/obj/effect/rune/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>Searching... sensor malfunction! Target lost. Aborting.</span>")
	return FALSE

/obj/structure/reagent_dispensers/fueltank/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>Destroying this object would cause a chain reaction. Aborting.</span>")
	return FALSE

/obj/structure/cable/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>Disrupting the power grid would bring no benefit to us. Aborting.</span>")
	return FALSE

/obj/machinery/portable_atmospherics/canister/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>An inhospitable area may be created as a result of destroying this object. Aborting.</span>")
	return FALSE

/obj/machinery/telecomms/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This communications relay should be preserved, it will be a useful resource to our masters in the future. Aborting.</span>")
	return FALSE

/obj/machinery/deepfryer/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This kitchen appliance should be preserved, it will make delicious unhealthy snacks for our masters in the future. Aborting.</span>")
	return FALSE
...
/obj/machinery/gateway/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This bluespace source will be important to us later. Aborting.</span>")
	return FALSE
...
/obj/item/stack/cable_coil/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)//Wiring would be too effective as a resource
	to_chat(S, "<span_class='warning'>This object does not contain enough materials to work with.</span>")
	return FALSE

/obj/machinery/porta_turret/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>Attempting to dismantle this machine would result in an immediate counterattack. Aborting.</span>")
	return FALSE
...
/mob/living/simple_animal/slime/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This biological resource is somehow resisting our bluespace transceiver. Aborting.</span>")
	return FALSE

/obj/machinery/droneDispenser/swarmer/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This object is receiving unactivated swarmer shells to help us. Aborting.</span>")
	return FALSE

/obj/structure/destructible/clockwork/massive/celestial_gateway/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This object is multiplying existing resources. Aborting.</span>")
	return FALSE
...
/obj/machinery/field/generator/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>Destroying this object would cause a catastrophic chain reaction. Aborting.</span>")
	return FALSE

/obj/machinery/field/containment/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>This object does not contain solid matter. Aborting.</span>")
	return FALSE

/obj/machinery/shieldwallgen/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span_class='warning'>Destroying this object would have an unpredictable effect on structure integrity. Aborting.</span>")
	return FALSE
...
/mob/living/simple_animal/hostile/swarmer/proc/Fabricate(atom/fabrication_object,fabrication_cost = 0)
	if(!isturf(loc))
		to_chat(src, "<span_class='warning'>This is not a suitable location for fabrication. We need more space.</span>")
	if(resources >= fabrication_cost)
		resources -= fabrication_cost
	else
		to_chat(src, "<span_class='warning'>You do not have the necessary resources to fabricate this object.</span>")
		return 0
...
/mob/living/simple_animal/hostile/swarmer/proc/Integrate(atom/movable/target)
	...
	if(resources + resource_gain > max_resources)
		to_chat(src, "<span_class='warning'>We cannot hold more materials!</span>")
		return TRUE
	if(resource_gain)
		...
		to_chat(src, "<span_class='warning'>[target] is incompatible with our internal matter recycler.</span>")
	return FALSE
...
/mob/living/simple_animal/hostile/swarmer/proc/DisperseTarget(mob/living/target)
	...
	if(!is_station_level(z) && !is_mining_level(z))
		to_chat(src, "<span_class='warning'>Our bluespace transceiver cannot locate a viable bluespace link, our teleportation abilities are useless in this area.</span>")
		return

	to_chat(src, "<span_class='info'>Attempting to remove this being from our presence.</span>")
...
/mob/living/simple_animal/hostile/swarmer/proc/DismantleMachine(obj/machinery/target)
	do_attack_animation(target)
	to_chat(src, "<span_class='info'>We begin to dismantle this machine. We will need to be uninterrupted.</span>")
	...
	if(do_mob(src, target, 100))
		to_chat(src, "<span_class='info'>Dismantling complete.</span>")
...
/mob/living/simple_animal/hostile/swarmer/proc/CreateTrap()
	...
	if(locate(/obj/structure/swarmer/trap) in loc)
		to_chat(src, "<span_class='warning'>There is already a trap here. Aborting.</span>")
		return
...
/mob/living/simple_animal/hostile/swarmer/proc/CreateBarricade()
	...
	if(locate(/obj/structure/swarmer/blockade) in loc)
		to_chat(src, "<span_class='warning'>There is already a blockade here. Aborting.</span>")
		return
	if(resources < 5)
		to_chat(src, "<span_class='warning'>We do not have the resources for this!</span>")
		return
...
/mob/living/simple_animal/hostile/swarmer/proc/CreateSwarmer()
	...
	to_chat(src, "<span_class='info'>We are attempting to replicate ourselves. We will need to stand still until the process is complete.</span>")
	if(resources < 50)
		to_chat(src, "<span_class='warning'>We do not have the resources for this!</span>")
		return
	if(!isturf(loc))
		to_chat(src, "<span_class='warning'>This is not a suitable location for replicating ourselves. We need more room.</span>")
		return
...
/mob/living/simple_animal/hostile/swarmer/proc/RepairSelf()
	...
	if(!isturf(loc))
		return
	to_chat(src, "<span_class='info'>Attempting to repair damage to our body, stand by...</span>")
	if(do_mob(src, src, 100))
		adjustHealth(-100)
		to_chat(src, "<span_class='info'>We successfully repaired ourselves.</span>")
