...
/datum/antagonist/wizard/greet()
	to_chat(owner, "<span_class='boldannounce'>You are the Space Wizard!</span>")
...
/datum/antagonist/wizard/farewell()
	to_chat(owner, "<span_class='userdanger'>You have been brainwashed! You are no longer a wizard!</span>")
...
/datum/antagonist/wizard/roundend_report()
	...
	if(wizardwin)
		parts += "<span_class='greentext'>The wizard was successful!</span>"
	else
		parts += "<span_class='redtext'>The wizard has failed!</span>"
...
/datum/team/wizard/roundend_report()
	...
	parts += "<span_class='header'>Wizards/witches of [master_wizard.owner.name] team were:</span>"
	parts += master_wizard.roundend_report()
	parts += " "
	parts += "<span_class='header'>[master_wizard.owner.name] apprentices were:</span>"
