...
/obj/structure/closet/proc/trigger_spooky_trap()
	if(!trapped)
		...
		visible_message("<span_class='userdanger'><font size='5'>BOO!</font></span>")
		playsound(loc, 'sound/spookoween/girlscream.ogg', 300, 1)
		trapped = 0
		QDEL_IN(trapped_mob, 90)

	else if(trapped == HOWLING_GHOST)
		visible_message("<span_class='userdanger'><font size='5'>[pick("OooOOooooOOOoOoOOooooOOOOO", "BooOOooOooooOOOO", "BOO!", "WoOOoOoooOooo")]</font></span>")
		...
		visible_message("<span_class='userdanger'><font size='5'>Protect your hair!</font></span>")
		...
		visible_message("<span_class='userdanger'>The closet bursts open!</span>")
		visible_message("<span_class='userdanger'><font size='5'>THIS BEING RADIATES PURE EVIL! YOU BETTER RUN!!!</font></span>")
		...
		visible_message("<span_class='userdanger'><font size='5'>...</font></span>")
...
/mob/living/simple_animal/hostile/retaliate/clown/insane/attackby(obj/item/O, mob/user)
	if(istype(O, /obj/item/nullrod))
		if(prob(5))
			...
			visible_message("<span_class='danger'>[src] seems to be resisting the effect!</span>")
	else
		..()
