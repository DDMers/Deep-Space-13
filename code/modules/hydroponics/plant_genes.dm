...
/datum/plant_gene/trait/squash
	...
	examine_line = "<span_class='info'>It has a lot of liquid contents inside.</span>"
...
/datum/plant_gene/trait/slip
	...
	name = "Slippery Skin"
	rate = 1.6
	examine_line = "<span_class='info'>It has a very slippery skin.</span>"
...
/datum/plant_gene/trait/cell_charge/on_consume(obj/item/reagent_containers/food/snacks/grown/G, mob/living/carbon/target)
	if(!G.reagents.total_volume)
		...
		if(batteries_recharged)
			to_chat(target, "<span_class='notice'>Your batteries are recharged!</span>")
...
/datum/plant_gene/trait/glow
	...
	rate = 0.03
	examine_line = "<span_class='info'>It emits a soft glow.</span>"
	trait_id = "glow"
...
/datum/plant_gene/trait/teleport/on_slip(obj/item/reagent_containers/food/snacks/grown/G, mob/living/carbon/C)
	...
	to_chat(C, "<span_class='warning'>You slip through spacetime!</span>")
...
/datum/plant_gene/trait/battery/on_attackby(obj/item/reagent_containers/food/snacks/grown/G, obj/item/I, mob/user)
	if(istype(I, /obj/item/stack/cable_coil))
		...
		if(C.use(5))
			to_chat(user, "<span_class='notice'>You add some cable to [G] and slide it inside the battery encasing.</span>")
			...
			to_chat(user, "<span_class='warning'>You need five lengths of cable to make a [G] battery!</span>")
...
/datum/plant_gene/trait/stinging/on_throw_impact(obj/item/reagent_containers/food/snacks/grown/G, atom/target)
	if(isliving(target) && G.reagents && G.reagents.total_volume)
		...
		if(L.reagents && L.can_inject(null, 0))
			...
			to_chat(target, "<span_class='danger'>You are pricked by [G]!</span>")
