...
/obj/item/reagent_containers/spray/weedspray/suicide_act(mob/user)
	user.visible_message("<span_class='suicide'>[user] is huffing [src]! It looks like [user.p_theyre()] trying to commit suicide!</span>")
	return (TOXLOSS)
...
/obj/item/cultivator/suicide_act(mob/user)
	user.visible_message("<span_class='suicide'>[user] is scratching [user.p_their()] back as hard as [user.p_they()] can with \the [src]! It looks like [user.p_theyre()] trying to commit suicide!</span>")
	return (BRUTELOSS)
...
/obj/item/hatchet/suicide_act(mob/user)
	user.visible_message("<span_class='suicide'>[user] is chopping at [user.p_them()]self with [src]! It looks like [user.p_theyre()] trying to commit suicide!</span>")
...
/obj/item/scythe/suicide_act(mob/user)
	user.visible_message("<span_class='suicide'>[user] is beheading [user.p_them()]self with [src]! It looks like [user.p_theyre()] trying to commit suicide!</span>")
	if(iscarbon(user))
