...
/mob/living/silicon/pai/Life()
	...
	if(cable)
		if(get_dist(src, cable) > 1)
			...
			T.visible_message("<span_class='warning'>[src.cable] rapidly retracts back into its spool.</span>", "<span_class='italics'>You hear a click and the sound of wire spooling rapidly.</span>")
			qdel(src.cable)
			cable = null
