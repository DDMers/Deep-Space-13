...
/mob/living/simple_animal/hostile/statue/Move(turf/NewLoc)
	if(can_be_seen(NewLoc))
		if(client)
			to_chat(src, "<span_class='warning'>You cannot move, there are eyes on you!</span>")
		return 0
	return ..()
...
/mob/living/simple_animal/hostile/statue/AttackingTarget()
	if(can_be_seen(get_turf(loc)))
		if(client)
			to_chat(src, "<span_class='warning'>You cannot attack, there are eyes on you!</span>")
		return FALSE
	else
		return ..()
...
/obj/effect/proc_holder/spell/aoe_turf/blindness
	...
	message = "<span_class='notice'>You glare your eyes.</span>"
	charge_max = 600
	clothes_req = 0
	range = 10
...
/obj/effect/proc_holder/spell/targeted/night_vision
	...
	message = "<span_class='notice'>You toggle your night vision!</span>"
	range = -1
	include_user = 1
