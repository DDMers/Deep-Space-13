...
/mob/living/simple_animal/pet/cat/cak/CheckParts(list/parts)
	...
	to_chat(src, "<span_class='big bold'>You are a cak!</span><b> You're a harmless cat/cake hybrid that everyone loves. People can take bites out of you if they're hungry, but you regenerate health \
	...
	if(new_name)
		to_chat(src, "<span_class='notice'>Your name is now <b>\"new_name\"</b>!</span>")
		name = new_name
