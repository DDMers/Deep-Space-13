...
/mob/living/simple_animal/shade/attack_animal(mob/living/simple_animal/M)
	if(isconstruct(M))
		...
		if(health < maxHealth)
			...
			M.visible_message("<span_class='danger'>[M] heals \the <b>[src]</b>.</span>", \
					   "<span_class='cult'>You heal <b>[src]</b>, leaving <b>[src]</b> at <b>[health]/[maxHealth]</b> health.</span>")
		else
			to_chat(M, "<span_class='cult'>You cannot heal <b>[src]</b>, as [p_theyre()] unharmed!</span>")
	else if(src != M)
		return ..()
