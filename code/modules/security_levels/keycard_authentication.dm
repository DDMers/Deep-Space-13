...
/obj/machinery/keycard_auth/proc/trigger_event(confirmer)
	...
	deadchat_broadcast("<span_class='deadsay'><span_class='name'>[triggerer]</span> triggered [event] at <span_class='name'>[A1.name]</span>.</span>", triggerer)

	var/area/A2 = get_area(confirmer)
	deadchat_broadcast("<span_class='deadsay'><span_class='name'>[confirmer]</span> confirmed [event] at <span_class='name'>[A2.name]</span>.</span>", confirmer)
	switch(event)
