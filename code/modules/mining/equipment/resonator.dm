...
/obj/item/resonator/attack_self(mob/user)
	if(burst_time == 50)
		burst_time = 30
		to_chat(user, "<span_class='info'>You set the resonator's fields to detonate after 3 seconds.</span>")
	else
		burst_time = 50
		to_chat(user, "<span_class='info'>You set the resonator's fields to detonate after 5 seconds.</span>")
...
/obj/effect/temp_visual/resonance/proc/burst()
	...
	for(var/mob/living/L in T)
		...
		to_chat(L, "<span_class='userdanger'>[src] ruptured with you in it!</span>")
