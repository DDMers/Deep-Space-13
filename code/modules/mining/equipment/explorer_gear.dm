...
/obj/item/clothing/suit/space/hostile_environment/process()
	...
	if(istype(C) && prob(2)) //cursed by bubblegum
		if(prob(15))
			...
			to_chat(C, "<span_class='colossus'><b>[pick("I AM IMMORTAL.","I SHALL TAKE BACK WHAT'S MINE.","I SEE YOU.","YOU CANNOT ESCAPE ME FOREVER.","DEATH CANNOT HOLD ME.")]</b></span>")
		else
			to_chat(C, "<span_class='warning'>[pick("You hear faint whispers.","You smell ash.","You feel hot.","You hear a roar in the distance.")]</span>")
