...
/obj/item/clothing/head/ushanka/attack_self(mob/user)
	if(earflaps)
		...
		earflaps = 0
		to_chat(user, "<span_class='notice'>You raise the ear flaps on the ushanka.</span>")
	else
		src.icon_state = "ushankadown"
		src.item_state = "ushankadown"
		earflaps = 1
		to_chat(user, "<span_class='notice'>You lower the ear flaps on the ushanka.</span>")
...
/obj/item/clothing/head/foilhat/equipped(mob/living/carbon/human/user, slot)
	...
	if(slot == SLOT_HEAD)
		...
		to_chat(user, "<span_class='warning'>As you don the foiled hat, an entire world of conspiracy theories and seemingly insane ideas suddenly rush into your mind. What you once thought unbelievable suddenly seems.. undeniable. Everything is connected and nothing happens just by accident. You know too much and now they're out to get you. </span>")
...
/obj/item/clothing/head/foilhat/attack_hand(mob/user)
	if(iscarbon(user))
		...
		if(src == C.head)
			to_chat(user, "<span_class='userdanger'>Why would you want to take this off? Do you want them to get into your mind?!</span>")
			return
	..()
