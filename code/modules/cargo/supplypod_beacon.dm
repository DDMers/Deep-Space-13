...
/obj/item/supplypod_beacon/examine(user)
	..()
	if(!express_console)
		to_chat(user, "<span_class='notice'>[src] is not currently linked to an Express Supply console.</span>")
	else
		to_chat(user, "<span_class='notice'>Alt-click to unlink it from the Express Supply console.</span>")
...
/obj/item/supplypod_beacon/proc/link_console(obj/machinery/computer/cargo/express/C, mob/living/user)
	...
	to_chat(user, "<span_class='notice'>[src] linked to [C].</span>")
...
/obj/item/supplypod_beacon/AltClick(mob/user)
	...
	if (express_console)
		...
		to_chat(user, "<span_class='notice'>There is no linked console!</span>")
