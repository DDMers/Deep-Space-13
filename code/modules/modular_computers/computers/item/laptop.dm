...
/obj/item/modular_computer/laptop/examine(mob/user)
	..()
	if(screen_on)
		to_chat(user, "<span_class='notice'>Alt-click to close it.</span>")
...
/obj/item/modular_computer/laptop/proc/toggle_open(mob/living/user=null)
	if(screen_on)
		to_chat(user, "<span_class='notice'>You close \the [src].</span>")
		slowdown = initial(slowdown)
		w_class = initial(w_class)
	else
		to_chat(user, "<span_class='notice'>You open \the [src].</span>")
