...
/obj/item/evidencebag/proc/evidencebagEquip(obj/item/I, mob/user)
	...
	if(istype(I, /obj/item/evidencebag))
		to_chat(user, "<span_class='notice'>You find putting an evidence bag in another evidence bag to be slightly absurd.</span>")
	...
	"<span_class='italics'>You hear a rustle as someone puts something into a plastic bag.</span>")
...
/obj/item/evidencebag/attack_self(mob/user)
	if(contents.len)
		...
		user.visible_message("[user] takes [I] out of [src].", "<span_class='notice'>You take [I] out of [src].</span>",\
		"<span_class='italics'>You hear someone rustle around in a plastic bag, and remove something.</span>")
