...
/obj/effect/immovablerod/wizard/penetrate(mob/living/L)
	if(L.anti_magic_check())
		L.visible_message("<span_class='danger'>[src] hits [L], but it bounces back, then vanishes!</span>" , "<span_class='userdanger'>[src] hits you... but it bounces back, then vanishes!</span>" , "<span_class ='danger'>You hear a weak, sad, CLANG.</span>")
		qdel(src)
		return
