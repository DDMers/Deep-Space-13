...
/proc/give_guns(mob/living/carbon/human/H)
	...
	to_chat(H, "<span_class='warning'>\A [G] appears [in_hand ? "in your hand" : "at your feet"]!</span>")
...
/proc/give_magic(mob/living/carbon/human/H)
	...
	to_chat(H, "<span_class='warning'>\A [M] appears [in_hand ? "in your hand" : "at your feet"]!</span>")
	if(lucky)
		to_chat(H, "<span_class='notice'>You feel incredibly lucky.</span>")


/proc/rightandwrong(summon_type, mob/user, survivor_probability)
	if(user) //in this case either someone holding a spellbook or a badmin
		to_chat(user, "<span_class='warning'>You summoned [summon_type]!</span>")
