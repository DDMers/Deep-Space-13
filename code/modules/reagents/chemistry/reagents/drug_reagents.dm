...
/datum/reagent/drug/space_drugs/overdose_start(mob/living/M)
	to_chat(M, "<span_class='userdanger'>You start tripping hard!</span>")
...
/datum/reagent/drug/nicotine/on_mob_life(mob/living/carbon/M)
	if(prob(1))
		...
		to_chat(M, "<span_class='notice'>[smoke_message]</span>")
...
/datum/reagent/drug/crank/on_mob_life(mob/living/carbon/M)
	if(prob(5))
		...
		to_chat(M, "<span_class='notice'>[high_message]</span>")
	M.AdjustStun(-20, FALSE)
	M.AdjustKnockdown(-20, FALSE)
	M.AdjustUnconscious(-20, FALSE)
	M.AdjustImmobilized(-20, FALSE)
...
/datum/reagent/drug/krokodil/addiction_act_stage2(mob/living/M)
	if(prob(25))
		to_chat(M, "<span_class='danger'>Your skin feels loose...</span>")
	..()

/datum/reagent/drug/krokodil/addiction_act_stage3(mob/living/M)
	if(prob(25))
		to_chat(M, "<span_class='danger'>Your skin starts to peel away...</span>")
...
/datum/reagent/drug/krokodil/addiction_act_stage4(mob/living/carbon/human/M)
	...
	if(!istype(M.dna.species, /datum/species/krokodil_addict))
		to_chat(M, "<span_class='userdanger'>Your skin falls off easily!</span>")
...
/datum/reagent/drug/methamphetamine/overdose_process(mob/living/M)
	...
	if(prob(20))
		M.emote("laugh")
	if(prob(33))
		M.visible_message("<span_class='danger'>[M]'s hands flip out and flail everywhere!</span>")
