...
/datum/reagent/water/holywater/reaction_mob(mob/living/M, method=TOUCH, reac_volume)
	if(is_servant_of_ratvar(M))
		to_chat(M, "<span_class='userdanger'>A darkness begins to spread its unholy tendrils through your mind, purging the Justiciar's influence!</span>")
	..()
...
/datum/reagent/water/holywater/on_mob_life(mob/living/carbon/M)
	...
	if(iscultist(M))
		for(var/datum/action/innate/cult/blood_magic/BM in M.actions)
			to_chat(M, "<span_class='cultlarge'>Your blood rites falter as holy water scours your body!</span>")
	...
	if(data >= 25)		// 10 units, 45 seconds @ metabolism 0.4 units & tick rate 1.8 sec
		...
		if(iscultist(M) && prob(20))
			...
			if(prob(10))
				M.visible_message("<span_class='danger'>[M] starts having a seizure!</span>", "<span_class='userdanger'>You have a seizure!</span>")
				M.Unconscious(120)
				to_chat(M, "<span_class='cultlarge'>[pick("Your blood is your bond - you are nothing without it", "Do not forget your place", \
			...
			switch(pick("speech", "message", "emote"))
				...
				if("message")
					to_chat(M, "<span_class='boldwarning'>[pick("Ratvar's illumination of your mind has begun to flicker", "He lies rusting in Reebe, derelict and forgotten. And there he shall stay", \
					"You can't save him. Nothing can save him now", "It seems that Nar'Sie will triumph after all")].</span>")
				if("emote")
					M.visible_message("<span_class='warning'>[M] [pick("whimpers quietly", "shivers as though cold", "glances around in paranoia")].</span>")
...
/datum/reagent/spraytan/reaction_mob(mob/living/M, method=TOUCH, reac_volume, show_message = 1)
	if(ishuman(M))
		...
		if(method == INGEST)
			if(show_message)
				to_chat(M, "<span_class='notice'>That tasted horrible.</span>")
	..()
...
/datum/reagent/mutationtoxin
	...
	var/mutationtext = "<span_class='danger'>The pain subsides. You feel... human.</span>"

/datum/reagent/mutationtoxin/on_mob_life(mob/living/carbon/human/H)
	..()
	if(!istype(H))
		return
	to_chat(H, "<span_class='warning'><b>You crumple in agony as your flesh wildly morphs into new forms!</b></span>")
...
/datum/reagent/mutationtoxin/proc/mutate(mob/living/carbon/human/H)
	...
	if(mutation && mutation != current_species)
		...
		to_chat(H, "<span_class='danger'>The pain vanishes suddenly. You feel no different.</span>")
...
/datum/reagent/mutationtoxin/classic //The one from plasma on green slimes
	...
	mutationtext = "<span_class='danger'>The pain subsides. Your whole body feels like slime.</span>"
...
/datum/reagent/mutationtoxin/felinid
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... like a degenerate.</span>"
...
/datum/reagent/mutationtoxin/lizard
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... scaly.</span>"
...
/datum/reagent/mutationtoxin/fly
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... buzzy.</span>"
...
/datum/reagent/mutationtoxin/moth
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... attracted to light.</span>"
...
/datum/reagent/mutationtoxin/pod
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... plantlike.</span>"
...
/datum/reagent/mutationtoxin/jelly
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... wobbly.</span>"
...
/datum/reagent/mutationtoxin/golem
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... rocky.</span>"
...
/datum/reagent/mutationtoxin/abductor
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... alien.</span>"
...
/datum/reagent/mutationtoxin/android
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... artificial.</span>"
...
/datum/reagent/mutationtoxin/skeleton
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... spooky.</span>"
...
/datum/reagent/mutationtoxin/zombie
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... undead.</span>"
...
/datum/reagent/mutationtoxin/ash
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... savage.</span>"
...
/datum/reagent/mutationtoxin/shadow
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... darker.</span>"
...
/datum/reagent/mutationtoxin/plasma
	...
	mutationtext = "<span_class='danger'>The pain subsides. You feel... flammable.</span>"
...
/datum/reagent/slime_toxin/on_mob_life(mob/living/carbon/human/H)
	...
	if(isjellyperson(H))
		to_chat(H, "<span_class='warning'>Your jelly shifts and morphs, turning you into another subspecies!</span>")
	...
	switch(current_cycle)
		if(1 to 6)
			if(prob(10))
				to_chat(H, "<span_class='warning'>[pick("You don't feel very well.", "Your skin feels a little slimy.")]</span>")
		if(7 to 12)
			if(prob(10))
				to_chat(H, "<span_class='warning'>[pick("Your appendages are melting away.", "Your limbs begin to lose their shape.")]</span>")
		if(13 to 19)
			if(prob(10))
				to_chat(H, "<span_class='warning'>[pick("You feel your internal organs turning into slime.", "You feel very slimelike.")]</span>")
		if(20 to INFINITY)
			var/species_type = pick(subtypesof(/datum/species/jelly))
			H.set_species(species_type)
			H.reagents.del_reagent(id)
			to_chat(H, "<span_class='warning'>You've become \a jellyperson!</span>")
...
/datum/reagent/mulligan/on_mob_life(mob/living/carbon/human/H)
	...
	if (!istype(H))
		return
	to_chat(H, "<span_class='warning'><b>You grit your teeth in pain as your body rapidly mutates!</b></span>")
...
/datum/reagent/bluespace/on_mob_life(mob/living/carbon/M)
	if(current_cycle > 10 && prob(15))
		to_chat(M, "<span_class='warning'>You feel unstable...</span>")
		M.Jitter(2)
		current_cycle = 1
