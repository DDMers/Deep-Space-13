...
/datum/chemical_reaction/heparin
	...
	mix_message = "<span_class='danger'>The mixture thins and loses all color.</span>"
...
/datum/chemical_reaction/rotatium
	...
	mix_message = "<span_class='danger'>After sparks, fire, and the smell of mindbreaker, the mix is constantly spinning with no stop in sight.</span>"
...
/datum/chemical_reaction/skewium
	...
	mix_message = "<span_class='danger'>Wow! it turns out if you mix rotatium with some plasma and sulphuric acid, it gets even worse!</span>"
...
/datum/chemical_reaction/bonehurtingjuice
	...
	mix_message = "<span_class='danger'>The mixture suddenly becomes clear and looks a lot like water. You feel a strong urge to drink it.</span>"
