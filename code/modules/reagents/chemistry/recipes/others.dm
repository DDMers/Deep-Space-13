...
/datum/chemical_reaction/foam/on_reaction(datum/reagents/holder, created_volume)
	...
	for(var/mob/M in viewers(5, location))
		to_chat(M, "<span_class='danger'>The solution spews out foam!</span>")
...
/datum/chemical_reaction/metalfoam/on_reaction(datum/reagents/holder, created_volume)
	...
	for(var/mob/M in viewers(5, location))
		to_chat(M, "<span_class='danger'>The solution spews out a metallic foam!</span>")
...
/datum/chemical_reaction/smart_foam/on_reaction(datum/reagents/holder, created_volume)
	...
	location.visible_message("<span_class='danger'>The solution spews out metallic foam!</span>")
