...
/datum/chemical_reaction/krokodil
	...
	required_reagents = list("diphenhydramine" = 1, "axonol" = 1, "cleaner" = 1, "potassium" = 1, "phosphorus" = 1, "welding_fuel" = 1)
...
/datum/chemical_reaction/methamphetamine
	...
	required_reagents = list("inaprovaline" = 1, "iodine" = 1, "phosphorus" = 1, "hydrogen" = 1)
	required_temp = 374
...
/datum/chemical_reaction/aranesp
	...
	required_reagents = list("inaprovaline" = 1, "morathial" = 1, "axonol" = 1)

/datum/chemical_reaction/happiness
	name = "Happiness"
	id = "happiness"
	results = list("happiness" = 4)
	required_reagents = list("nitrous_oxide" = 2, "inaprovaline" = 1, "ethanol" = 1)
