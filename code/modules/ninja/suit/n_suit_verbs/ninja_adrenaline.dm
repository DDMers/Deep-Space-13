...
/obj/item/clothing/suit/space/space_ninja/proc/ninjaboost()
	...
	if(!ninjacost(0,N_ADRENALINE))
		...
		a_boost--
		to_chat(H, "<span_class='notice'>There are <B>[a_boost]</B> adrenaline boosts remaining.</span>")
		s_coold = 3
...
/obj/item/clothing/suit/space/space_ninja/proc/ninjaboost_after()
	...
	to_chat(H, "<span_class='danger'>You are beginning to feel the after-effect of the injection.</span>")
