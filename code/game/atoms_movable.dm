...
/atom/movable/proc/force_push(atom/movable/AM, force = move_force, direction, silent = FALSE)
	...
	if(!silent && .)
		visible_message("<span_class='warning'>[src] forcefully pushes against [AM]!</span>", "<span_class='warning'>You forcefully push against [AM]!</span>")

/atom/movable/proc/move_crush(atom/movable/AM, force = move_force, direction, silent = FALSE)
	. = AM.move_crushed(src, force, direction)
	if(!silent && .)
		visible_message("<span_class='danger'>[src] crushes past [AM]!</span>", "<span_class='danger'>You crush [AM]!</span>")
