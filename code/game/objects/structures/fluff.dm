...
/obj/structure/fluff/attackby(obj/item/I, mob/living/user, params)
	if(I.tool_behaviour == TOOL_WRENCH && deconstructible)
		user.visible_message("<span_class='notice'>[user] starts disassembling [src]...</span>", "<span_class='notice'>You start disassembling [src]...</span>")
		I.play_tool_sound(src)
		if(I.use_tool(src, user, 50))
			user.visible_message("<span_class='notice'>[user] disassembles [src]!</span>", "<span_class='notice'>You break down [src] into scrap metal.</span>")
