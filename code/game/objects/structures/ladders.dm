...
/obj/structure/ladder/singularity_pull()
	if (!(resistance_flags & INDESTRUCTIBLE))
		visible_message("<span_class='danger'>[src] is torn to pieces by the gravitational pull!</span>")
		qdel(src)
...
/obj/structure/ladder/proc/use(mob/user, is_ghost=FALSE)
	...
	if (up && down)
		...
		to_chat(user, "<span_class='warning'>[src] doesn't seem to lead anywhere!</span>")
...
/obj/structure/ladder/proc/show_fluff_message(going_up, mob/user)
	if(going_up)
		user.visible_message("[user] climbs up [src].","<span_class='notice'>You climb up [src].</span>")
	else
		user.visible_message("[user] climbs down [src].","<span_class='notice'>You climb down [src].</span>")
