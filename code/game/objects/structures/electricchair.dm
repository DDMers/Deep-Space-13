...
/obj/structure/chair/e_chair/proc/shock()
	...
	if(has_buckled_mobs())
		for(var/m in buckled_mobs)
			...
			to_chat(buckled_mob, "<span_class='userdanger'>You feel a deep shock course through your body!</span>")
			addtimer(CALLBACK(buckled_mob, /mob/living.proc/electrocute_act, 85, src, 1), 1)
	visible_message("<span_class='danger'>The electric chair went off!</span>", "<span_class='italics'>You hear a deep sharp shock!</span>")
