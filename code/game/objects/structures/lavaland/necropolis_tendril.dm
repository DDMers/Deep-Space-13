...
/obj/effect/collapse/Initialize()
	. = ..()
	emitted_light = new(loc)
	visible_message("<span_class='boldannounce'>The tendril writhes in fury as the earth around it begins to crack and break apart! Get back!</span>")
	visible_message("<span_class='warning'>Something falls free of the tendril!</span>")
...
/obj/effect/collapse/proc/collapse()
	...
	visible_message("<span_class='boldannounce'>The tendril falls inward, the ground around it widening into a yawning chasm!</span>")
