...
/obj/effect/mob_spawn/human/seed_vault
	...
	flavour_text = "<span_class='big bold'>You are a sentient ecosystem,</span><b> an example of the mastery over life that your creators possessed. Your masters, benevolent as they were, created uncounted \
...
/obj/effect/mob_spawn/human/ash_walker
	...
	density = FALSE
	flavour_text = "<span_class='big bold'>You are an ash walker.</span><b> Your tribe worships <span_class='danger'>the Necropolis</span>. The wastes are sacred ground, its monsters a blessed bounty. \
...
/obj/effect/mob_spawn/human/exile
	...
	flavour_text = "<span_class='big bold'>You are cursed.</span><b> Years ago, you sacrificed the lives of your trusted friends and the humanity of yourself to reach the Wish Granter. Though you \
...
/obj/effect/mob_spawn/human/golem
	...
	flavour_text = "<span_class='big bold'>You are a Free Golem.</span><b> Your family worships <span_class='danger'>The Liberator</span>. In his infinite and divine wisdom, he set your clan free to \
...
/obj/effect/mob_spawn/human/golem/Initialize(mapload, datum/species/golem/species = null, mob/creator = null)
	...
	if(has_owner && creator)
		flavour_text = "<span_class='big bold'>You are a Golem.</span><b> You move slowly, but are highly resistant to heat and cold as well as blunt trauma. You are unable to wear clothes, but can still use most tools. \
...
/obj/effect/mob_spawn/human/golem/attack_hand(mob/user)
	...
	if(isgolem(user) && can_transfer)
		...
		user.visible_message("<span_class='notice'>A faint light leaves [user], moving to [src] and animating it!</span>","<span_class='notice'>You leave your old body behind, and transfer into [src]!</span>")
		show_flavour = FALSE
...
/obj/effect/mob_spawn/human/hermit
	...
	flavour_text = "<span_class='big bold'>You've been stranded in this godless prison of a planet for longer than you can remember.</span><b> Each day you barely scrape by, and between the terrible \
...
/obj/effect/mob_spawn/human/doctor/alive/lavaland
	...
	flavour_text = "<span_class='big bold'>What...?</span><b> Where are you? Where are the others? This is still the animal hospital - you should know, you've been an intern here for weeks - but \
...
/obj/effect/mob_spawn/human/prisoner_transport
	...
	roundstart = FALSE
	death = FALSE
	flavour_text = "<b>Good. It seems as though your ship crashed. <span_class='big bold'>You're a prisoner,</span> sentenced to hard work in one of Nanotrasen's labor camps, but it seems as \
...
/obj/effect/mob_spawn/human/hotel_staff //not free antag u little shits
	...
	flavour_text = "<span_class='big bold'>You are a staff member of a top-of-the-line space hotel!</span><b> Cater to guests and <font size=6><b>DON'T</b></font> leave the hotel, lest the manager fire you for\
...
/obj/effect/mob_spawn/human/hotel_staff/security
	...
	flavour_text = "<span_class='big bold'>You are a peacekeeper</span><b> assigned to this hotel to protect the interests of the company while keeping the peace between \
...
/obj/effect/mob_spawn/human/demonic_friend/Initialize(mapload, datum/mind/owner_mind, obj/effect/proc_holder/spell/targeted/summon_friend/summoning_spell)
	. = ..()
	owner = owner_mind
	flavour_text = "<span_class='big bold'>You have been given a reprieve from your eternity of torment, to be [owner.name]'s friend for [owner.p_their()] short mortal coil.</span><b> Be aware that if you do not live up to [owner.name]'s expectations, they can send you back to hell with a single thought.  [owner.name]'s death will also return you to hell.</b>"
	var/area/A = get_area(src)
	if(!mapload && A)
...
/obj/effect/mob_spawn/human/demonic_friend/special(mob/living/L)
	if(!QDELETED(owner.current) && owner.current.stat != DEAD)
		...
		to_chat(L, "<span_class='userdanger'>Your owner is already dead!  You will soon perish.</span>")
...
/obj/effect/mob_spawn/human/syndicate/battlecruiser
	...
	flavour_text = "<span_class='big bold'>You are a crewmember aboard the syndicate flagship: the SBC Starfury.</span><span_class='big'> <span_class='danger'><b>Your job is to follow your captain's orders, maintain the ship, and keep the engine running.</b></span> If you are not familiar with how the supermatter engine functions: <b>do not attempt to start it.</b><br>\
	<br>\
	<span_class='danger'><b>The armory is not a candy store, and your role is not to assault the station directly, leave that work to the assault operatives.</b></span></font>"
...
/obj/effect/mob_spawn/human/syndicate/battlecruiser/assault
	...
	flavour_text = "<span_class='big bold'>You are an assault operative aboard the syndicate flagship: the SBC Starfury.</span><span_class='big'> <span_class='danger'><b>Your job is to follow your captain's orders, keep intruders out of the ship, and assault Space Station 13.</b></span> There is an armory, multiple assault ships, and beam cannons to attack the station with.<br>\
	<br>\
	<span_class='danger'><b>Work as a team with your fellow operatives and work out a plan of attack. If you are overwhelmed, escape back to your ship!</b></span></span>"
...
/obj/effect/mob_spawn/human/syndicate/battlecruiser/captain
	...
	flavour_text = "<span_class='big bold'>You are the captain aboard the syndicate flagship: the SBC Starfury.</span><span_class='big'> <span_class='danger'><b>Your job is to oversee your crew, defend the ship, and destroy Space Station 13.</b></span> The ship has an armory, multiple ships, beam cannons, and multiple crewmembers to accomplish this goal.<br>\
	<br>\
	<span_class='danger'><b>As the captain, this whole operation falls on your shoulders.</b></span> You do not need to nuke the station, causing sufficient damage and preventing your ship from being destroyed will be enough.</span>"
...
/obj/effect/mob_spawn/human/oldsec
	...
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span_class='big bold'>You are a security officer working for Nanotrasen,</span><b> stationed onboard a state of the art research station. You vaguely recall rushing into a \
...
/obj/effect/mob_spawn/human/oldeng
	...
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span_class='big bold'>You are an engineer working for Nanotrasen,</span><b> stationed onboard a state of the art research station. You vaguely recall rushing into a \
	cryogenics pod due to an oncoming radiation storm. The last thing you remember is the station's Artificial Program telling you that you would only be asleep for eight hours. As you open \
	your eyes, everything seems rusted and broken, a dark feeling swells in your gut as you climb out of your pod. \
	Work as a team with your fellow survivors and do not abandon them.</b>"
...
/obj/effect/mob_spawn/human/oldsci
	...
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span_class='big bold'>You are a scientist working for Nanotrasen,</span><b> stationed onboard a state of the art research station. You vaguely recall rushing into a \
	cryogenics pod due to an oncoming radiation storm. The last thing you remember is the station's Artificial Program telling you that you would only be asleep for eight hours. As you open \
	your eyes, everything seems rusted and broken, a dark feeling swells in your gut as you climb out of your pod. \
	Work as a team with your fellow survivors and do not abandon them.</b>"
...
/obj/effect/mob_spawn/human/pirate
	...
	flavour_text = "<span_class='big bold'>You are a space pirate.</span><b> The station refused to pay for your protection, protect the ship, siphon the credits from the station and raid it for even more loot.</b>"
