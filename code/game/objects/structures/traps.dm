...
/obj/structure/trap/examine(mob/user)
	...
	if(get_dist(user, src) <= 1)
		to_chat(user, "<span_class='notice'>You reveal [src]!</span>")
		flare()

/obj/structure/trap/proc/flare()
	// Makes the trap visible, and starts the cooldown until it's
	// able to be triggered again.
	visible_message("<span_class='warning'>[src] flares brightly!</span>")
	spark_system.start()
	alpha = 200
...
/obj/structure/trap/fire/trap_effect(mob/living/L)
	to_chat(L, "<span_class='danger'><B>Spontaneous combustion!</B></span>")
	L.Paralyze(20)
...
/obj/structure/trap/chill/trap_effect(mob/living/L)
	to_chat(L, "<span_class='danger'><B>You're frozen solid!</B></span>")
	L.Paralyze(20)
...
/obj/structure/trap/damage/trap_effect(mob/living/L)
	to_chat(L, "<span_class='danger'><B>The ground quakes beneath your feet!</B></span>")
	L.Paralyze(100)
