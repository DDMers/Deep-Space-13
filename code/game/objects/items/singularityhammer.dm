...
/obj/item/twohanded/mjollnir/proc/shock(mob/living/target)
	...
	s.start()
	target.visible_message("<span_class='danger'>[target.name] was shocked by [src]!</span>", \
		"<span_class='userdanger'>You feel a powerful shock course through your body sending you flying!</span>", \
