...
/obj/item/choice_beacon/proc/spawn_option(obj/choice,mob/living/M)
	...
	var/msg = "<span_class=danger>After making your selection, you notice a strange target on the ground. It might be best to step back!</span>"
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
		if(istype(H.ears, /obj/item/radio/headset))
			msg = "You hear something crackle in your ears for a moment before a voice speaks.  \"Please stand by for a message from Central Command.  Message as follows: <span_class='bold'>Item request received. Your package is inbound, please stand back from the landing site.</span> Message ends.\""
	to_chat(M, msg)
...
/obj/item/skub/suicide_act(mob/living/user)
	user.visible_message("<span_class='suicide'>[user] has declared themself as anti-skub! The skub tears them apart!</span>")
