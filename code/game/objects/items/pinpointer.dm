...
/obj/item/pinpointer/attack_self(mob/living/user)
	toggle_on()
	user.visible_message("<span_class='notice'>[user] [active ? "" : "de"]activates [user.p_their()] pinpointer.</span>", "<span_class='notice'>You [active ? "" : "de"]activate your pinpointer.</span>")
...
/obj/item/pinpointer/crew/attack_self(mob/living/user)
	if(active)
		toggle_on()
		user.visible_message("<span_class='notice'>[user] deactivates [user.p_their()] pinpointer.</span>", "<span_class='notice'>You deactivate your pinpointer.</span>")
		return
	...
	if(!names.len)
		user.visible_message("<span_class='notice'>[user]'s pinpointer fails to detect a signal.</span>", "<span_class='notice'>Your pinpointer fails to detect a signal.</span>")
		return
	...
	target = names[A]
	toggle_on()
	user.visible_message("<span_class='notice'>[user] activates [user.p_their()] pinpointer.</span>", "<span_class='notice'>You activate your pinpointer.</span>")
