...
/obj/item/mecha_parts/mecha_equipment/drill/action(atom/target)
	...
	if(isobj(target))
		...
		if(target_obj.resistance_flags & UNACIDABLE)
			return
	target.visible_message("<span_class='warning'>[chassis] starts to drill [target].</span>", \
					"<span_class='userdanger'>[chassis] starts to drill [target]...</span>", \
					 "<span_class='italics'>You hear drilling.</span>")
...
/turf/closed/wall/r_wall/drill_act(obj/item/mecha_parts/mecha_equipment/drill/drill)
	if(drill.drill_level >= DRILL_HARDENED)
		...
		drill.occupant_message("<span_class='danger'>[src] is too durable to drill through.</span>")
...
/obj/item/mecha_parts/mecha_equipment/drill/proc/drill_mob(mob/living/target, mob/user)
	target.visible_message("<span_class='danger'>[chassis] is drilling [target] with [src]!</span>", \
						"<span_class='userdanger'>[chassis] is drilling you with [src]!</span>")
