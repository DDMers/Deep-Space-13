...
/datum/game_mode/monkey/special_report()
	if(check_monkey_victory())
		return "<span_class='redtext big'>The monkeys have overthrown their captors! Eeek eeeek!!</span>"
	else
		return "<span_class='redtext big'>The staff managed to contain the monkey infestation!</span>"
