...
/obj/structure/barricade/wooden/attackby(obj/item/I, mob/user)
	if(istype(I,/obj/item/stack/sheet/mineral/wood))
		...
		if(W.amount < 5)
			to_chat(user, "<span_class='warning'>You need at least five wooden planks to make a wall!</span>")
			return
		else
			to_chat(user, "<span_class='notice'>You start adding [I] to [src]...</span>")
...
/obj/structure/barricade/security/proc/deploy()
	...
	anchored = TRUE
	if(deploy_message)
		visible_message("<span_class='warning'>[src] deploys!</span>")
...
/obj/item/grenade/barrier/examine(mob/user)
	..()
	to_chat(user, "<span_class='notice'>Alt-click to toggle modes.</span>")
