...
<A href='?src=[REF(src)];command=cycle_exterior'>Cycle to Exterior Airlock</A><BR>"}
			current_status = "Interior Airlock Open<BR><span_class='good'>Chamber Pressurized</span>"
		if(AIRLOCK_STATE_PRESSURIZE)
			state_options = "<A href='?src=[REF(src)];command=abort'>Abort Cycling</A><BR>"
			current_status = "Cycling to Interior Airlock<BR><span_class='average'>Chamber Pressurizing</span>"
		if(AIRLOCK_STATE_CLOSED)
...
<A href='?src=[REF(src)];command=cycle_exterior'>Open Exterior Airlock</A><BR>"}
		if(AIRLOCK_STATE_DEPRESSURIZE)
			state_options = "<A href='?src=[REF(src)];command=abort'>Abort Cycling</A><BR>"
			current_status = "Cycling to Exterior Airlock<BR><span_class='average'>Chamber Depressurizing</span>"
...
<A href='?src=[REF(src)];command=cycle_closed'>Close Exterior Airlock</A><BR>"}
			current_status = "Exterior Airlock Open<BR><span_class='bad'>Chamber Depressurized</span>"
